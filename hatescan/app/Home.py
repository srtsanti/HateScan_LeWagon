...
santi = Image.open('/Users/joaquinortega/code/joaquin-ortega84/hatescan/raw_data/HateScan/hatescan/app/logo_hscan.png')

# st.title('Hi, welcome to')

# st.image(santi, width=300)

# st.write('Click on the nav icon on your left to start scanning!')


# st.subheader("Uncover linguistic patterns and gain insights from tweets")
# st.write("With HateScan, you can analyze language usage and preferred topics in tweets from friends, celebrities, and public figures. Compare individuals to gain a deeper understanding of speech patterns and explore prevalent topics.")
# st.write("Uncover language nuances, identify recurring themes, and broaden your perspective on current events. HateScan empowers you to explore the power of language and gain valuable insights into those around you.")
...
# Display the layout
st.image(santi, use_column_width=True)
